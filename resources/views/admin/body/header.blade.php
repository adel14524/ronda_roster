        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index.html" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="{{ asset('admin/assets/images/ronda_logo_light.png') }}" alt="logo-dark" height="20">
                    </span>
                </a>
                ...
                <a href="index.html" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{ asset('admin/assets/images/ronda_logo_light.png') }}" alt="logo-light" height="20">
                    </span>
                </a>
            </div>
